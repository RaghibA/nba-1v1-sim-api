  ...
  while (p1Score <= 11 || p2Score <= 11) {
    ...
    if (pos === 0) { // Player 1 Possesion
      ...
      if (takeThree === false) { // Take midrange shot
        ...
        if (tp === true) { p2Score += 2 }
        else { swapPos = true } // TODO: Add rebound logic
      } // End Player 2 
    }

    //! Update simulation data
    sim.turns.push({ turn, p1Score, p2Score, pos, shot })
